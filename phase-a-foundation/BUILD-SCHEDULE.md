...
| # | Block | Goal | Commit |
|---|---|---|---|
| A.1 | Sun | Wazuh agent + Sysmon (Hartong) on the **Dell OptiPlex 7070** (Windows 10, bare metal — EOL Oct 2025, kept deliberately as the victim-network box); enrolled into `phase-a-windows`, status active | `phase-a: windows agent + sysmon` |
